...
import com.my.blog.website.service.impl.BqiTickerServiceImpl;
...
public class IndexController extends BaseController {
    ...
    @Autowired
    private BqiTickerServiceImpl bqiTickerService;
...
//    /**
//     * 首页 --- 按分类查询 add by jiutian
//     *
//     * @return
//     */
//    @GetMapping(value = {"index/{category}"})
//    public String indexbyCategory(HttpServletRequest request, @PathVariable String category, @RequestParam(value = "limit", defaultValue = "12") int limit) {
//        return this.index(request, 1, limit);
//    }
    ...
    public String indexbyCategory(HttpServletRequest request, @PathVariable int p, @PathVariable String category, @RequestParam(value = "limit", defaultValue = "6") int limit) {
        p = p < 0 || p > WebConst.MAX_PAGE ? 1 : p;
        PageInfo<ContentVo> articles = null;
        try {
            articles = contentService.getContentsByCategory(p, category,limit);
        } catch (IOException e) {
            e.printStackTrace();
        }
        request.setAttribute("articles", articles);
...
//    }
    ...
    public String categories(HttpServletRequest request, @PathVariable String keyword,
        ...
        PageInfo<ContentVo> articles = null;
        try {
            articles = contentService.getContentsByCategory(page, keyword,limit);
        } catch (IOException e) {
            e.printStackTrace();
        }
        request.setAttribute("articles", articles);
...
//        request.setAttribute("archives", null);
...
//    }
    ...
    @GetMapping(value = "archives")
    public String archives(HttpServletRequest request) {
        List<CatalogueBo> archives = siteService.getArchives();
    ...
    public String contents(HttpServletRequest request) {
        List<BqiTickerTable> bqiTickerTables = bqiTickerService.GetBqiTickerList();
        request.setAttribute("contents", bqiTickerTables);
